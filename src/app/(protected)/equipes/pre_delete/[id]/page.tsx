...
import { EquipeDeleteForm } from "@/app/(protected)/_components/equipes/EquipeDeleteForm"
...
export default async function PreDeletePage(props: PageParams) {
  ...
  const equipe = await equipeGet(params.id)
      ...
      <div className="pt-5 px-2 lg:px-8">
        <div className={`mb-4 flex items-center justify-between`}>
          <div className="container_title">
            <h2 className="text-2xl font-bold">Antes de apagar a equipe:</h2>
          </div>
        </div>
        <Separator />
