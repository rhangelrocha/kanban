  ...
  return (
    <>
      <div className="container relative h-[100vh] flex-col items-center justify-center grid md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className={cn('relative h-full flex-col bg-muted p-10 text-white dark:border-r login-left hidden lg:flex xl:flex', styles.login_left)}>
          ...
          {/* <div className="relative z-20 mt-auto">
            <blockquote className="space-y-2">
              <p className="text-lg">
                &ldquo;Entregar ou entregar.&rdquo;
              </p>
              <footer className="text-sm">Muniz, Danillo</footer>
            </blockquote>
          </div> */}
        </div>
        <div className="lg:p-8 sm:p-8">
